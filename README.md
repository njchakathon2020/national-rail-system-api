...
The access token received by email needs to be passed with every request as header. In national.rail.system.api.dev.yaml file, replace '******' with the access token for nre.accessToken property.
...
The access token received by email needs to be passed with every request as header. In national.rail.system.api.dev.yaml file, replace '******' with the access token for nrePV.accessToken property.
